 ...
 */
export function removeEventListener(eventName: string, callback: EventListenerCallback): void {
...
export function createUseHostEvent(): UseHostEventReturn {
  return (eventName: string, callback: EventListenerCallback): HostEventSubscription => {
