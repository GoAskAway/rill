...
import * as RillReconciler from '../../let/src/reconciler/index';
...
import type { RuntimeCollectorConfig, RuntimeCollector } from '../../devtools/src/index';
import { createRuntimeCollector } from '../../devtools/src/index';
...
import type { JSEngineContext, JSEngineProvider, JSEngineRuntime } from '../../sandbox/src/index';
  ...
  constructor(options: EngineOptions = {}) {
    ...
    if (!this.options.provider) {
      try {
        ...
        const { DefaultProvider } = require('../../sandbox/src/index');
